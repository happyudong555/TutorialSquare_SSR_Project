 ...
 */
function areRectsOnOneLine(rects: Array<ClientRect>, lineHeight: number): boolean {
  var minTop = Infinity;
...
function expandRangeToStartOfLine(range: Range): Range {
  ...
  while (areRectsOnOneLine(getRangeClientRects(range), lineHeight)) {
    ...
    if (bestContainer.nodeType === 1 && getComputedStyle((bestContainer: any)).display !== 'inline') {
