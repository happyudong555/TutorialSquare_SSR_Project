...
function getBlockMapSupportedTags(blockRenderMap: DraftBlockRenderMap): Array<string> {
>>>>>>> 3e7cc9eba236ff5c5205c34bae31be88b995768b
...
// custom element conversions
function getMultiMatchedType(tag: string, lastList: ?string, multiMatchExtractor: Array<Function>): ?DraftBlockType {
>>>>>>> 3e7cc9eba236ff5c5205c34bae31be88b995768b
...
function getBlockTypeForTag(tag: string, lastList: ?string, blockRenderMap: DraftBlockRenderMap): DraftBlockType {
>>>>>>> 3e7cc9eba236ff5c5205c34bae31be88b995768b
...
function processInlineTag(tag: string, node: Node, currentStyle: DraftInlineStyle): DraftInlineStyle {
...
function genFragment(entityMap: EntityMap, node: Node, inlineStyle: DraftInlineStyle, lastList: string, inBlock: ?string, blockTags: Array<string>, depth: number, blockRenderMap: DraftBlockRenderMap, inEntity?: string): { chunk: Chunk; entityMap: EntityMap; } {
...
=======
    } = genFragment(newEntityMap, child, inlineStyle, lastList, inBlock, blockTags, depth, blockRenderMap, entityId || inEntity);
>>>>>>> 3e7cc9eba236ff5c5205c34bae31be88b995768b
...
function getChunkForHTML(html: string, DOMBuilder: Function, blockRenderMap: DraftBlockRenderMap, entityMap: EntityMap): ?{ chunk: Chunk; entityMap: EntityMap; } {
>>>>>>> 3e7cc9eba236ff5c5205c34bae31be88b995768b
...
=======
  ...
  } = genFragment(entityMap, safeBody, OrderedSet(), 'ul', null, workingBlocks, -1, blockRenderMap);
>>>>>>> 3e7cc9eba236ff5c5205c34bae31be88b995768b
...
function convertFromHTMLtoContentBlocks(html: string, DOMBuilder: Function = getSafeBodyFromHTML, blockRenderMap?: DraftBlockRenderMap = DefaultDraftBlockRenderMap): ?{ contentBlocks: ?Array<ContentBlock>; entityMap: EntityMap; } {
>>>>>>> 3e7cc9eba236ff5c5205c34bae31be88b995768b
...
=======
  ...
  return {
    contentBlocks: chunk.text.split('\r').map((textBlock, ii) => {
      ...
      var characterList = List(inlines.map((style, ii) => {
