...
function getRemovalRange(characters: List<CharacterMetadata>, key: ?string, offset: number): Object {
  var removalRange;
  findRangesImmutable(characters, (a, b) => a.getEntity() === b.getEntity(), element => element.getEntity() === key, (start, end) => {
...
=======
function removeForBlock(entityMap: EntityMap, block: ContentBlock, offset: number): ContentBlock {
>>>>>>> 3e7cc9eba236ff5c5205c34bae31be88b995768b
