...
import { Rate, Icon,Collapse } from 'antd';
export default ({url:{ query: { id }}}) => {
let courseDetail = data.find(course, { id:id } );
const Panel = Collapse.Panel;
let course_purchased = course.sort();
        return (
            <div>
              <Head>
               ...
               <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
                  ...
                  <div className="row">
                    <div className="container header_content clearfix">
                      <div className="col-md-6 courseThumbnails">
                          ...
                          <br/>
                          <a href="#playlist" className="btn playList_btn" style={{color:'#fff'}}>play list</a>
                      </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="courseDescription col-md-12">
                            ...
                            <br/>
                            <h6><strong>yours Course</strong></h6>
                            <br/>
                            <div id="playlist">
                                <Collapse accordion>
                                    {
                                        course_purchased.map( (course_purchased,i) => (
                                            <Panel header={course_purchased.name} key={i}>
                                            <p>{course_purchased.content}</p>
                                            <div className="video_purchased">
                                                <video src={`static/public/video/${course_purchased.video}`} 
                ...
                <style>
                    {`
                        ...
                        .video_purchased video {
                            width: 100%;
                            height: 100%;
                            background-image: url(/static/public/background/video-cover-default.svg);
