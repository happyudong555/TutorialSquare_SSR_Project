...
import InventoryItem from '../static/database/InventoryItem'
...
export default class Inventory extends React.Component {
    ...
    render() {
        ...
        <div className="container">
                <h3 className="HeadingTitle">inventory</h3>
                <div className="row">
                <style>
                    {`
                ...
                <div className="container">
                    ...
                    {
                        InventoryItem.map( (InventoryItem,i) => (
                        <div key={i} className="col-sm-6 col-md-4 card courseBox" 
                        style={{height: '268px'}}>
                            <div className="courseThumbnail">
                                <a href={`/teacher_video_purchased?id=${InventoryItem.id}`}>
                                <img className="img-responsive" 
                                src={`static/public/images/${InventoryItem.image}`} /></a>
                                <a href={`/teacher_video_purchased?id=${InventoryItem.id}`}>
                                <h6>{InventoryItem.name}</h6></a>
                                <p className="category">{InventoryItem.category}</p>
                            </div>
                        </div>
                    ))
                    }
