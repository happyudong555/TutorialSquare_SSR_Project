...
import User_Profile_setting from '../pages/user_Profile_setting'
    ...
    render(){
        return (
            <div>
               ...
               <title>Tutorial Square | Dashboard</title>
               ...
               <nav className="navbar navbar-default storeNavbar">
                    <div className="container">
                        <div className="navbar-header">
                            <Link className="navbar-brand" href={{ pathname: '/store', query: { store: 'id' } }}>
               ...
               <div className="container container-dashboard">
                    <div className="SideBar col-md-3">
                        <img className="img-responsive" src={`static/public/images/${this.state.imgUrl}`}/>
                        <h5 className="text-center displayName">{this.state.displayName}</h5>
                        <ul className="list-group Tabsmenu nav nav-tabs" role="tablist">
                                <li className="list-group-item text-center active">
                                    <a href="#mycourse" role="tab" data-toggle="tab">my course</a>
                                </li>
                                <li className="list-group-item text-center">
                                    <a href="#Profile_setting" role="tab" data-toggle="tab">profile setting</a>
                                </li>
                                <li className="list-group-item text-center">
                                    <Link href={{ pathname: '/faq_student', query: { store: 'id' } }} role="tab" data-toggle="tab">faq</Link>
                                </li>
                                <li className="list-group-item text-center">
                                    <a href="/">log out</a>
                                </li>
                    ...
                    <div className="col-md-8 wrapper_my_post">
                        <div className="tab-content">
                            <div role="tabpanel" className="tab-pane active" id="mycourse">
                                <MyCourse/>
                            </div>
